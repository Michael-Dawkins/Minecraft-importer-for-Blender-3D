from MBImportMap.MCImportRegion import MCImportRegion
import re
import zlib
from MBImportMap import MCImportBetaChunk

##Permet l'importation d'un fichier de region minecraft (.mcr)
class MCImportBetaRegion(MCImportRegion):
    ...
    def getChunk(self,x,z):
        ...
        chunk = MCImportBetaChunk.MCImportBetaMapChunk()
